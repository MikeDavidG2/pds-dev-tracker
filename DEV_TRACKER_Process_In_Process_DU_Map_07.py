...
def main():
    ...
    shorthand_name    = 'In_Process_DU_Map_07'
    ...
    name_of_csv       = 'Dwelling Units - Discretionary In-Process (Map 7).csv'
    ...
    if success == True:
        try:
            ...
            success = False
            print '*** ERROR with Set "fc_to_be_joined" or Merge PARCELS_ALL and PARCEL_HISTORICAL ***'
            print str(e)
