...
def main():
    ...
    SANDAG_LU_DU_2012 = os.path.join(prod_SDE_conn_file, prod_SDE_prefix + 'SANDAG_LU_DU_2012')
    JUR_MUNICIPAL     = os.path.join(prod_SDE_conn_file, prod_SDE_prefix + 'JUR_MUNICIPAL')
